...
export const Navbar = ({ menuOpen, setMenuOpen }) => {
    ...
    return (
        <nav className="fixed w-full z-50 top-2 px-4 sm:top-4 sm:px-6">
            <div className="mx-auto max-w-7xl bg-white/[0.05] backdrop-blur-md md:backdrop-blur-xl border border-white/10 shadow-[0_8px_32px_rgba(0,0,0,0.3),inset_0_1px_2px_rgba(255,255,255,0.1)] rounded-full py-3 px-6">
                <div className="flex justify-between items-center">
                    ...
                    <div
                        className="w-10 h-10 flex items-center justify-center rounded-full bg-white/5 border border-white/10 text-xl cursor-pointer z-50 md:hidden hover:bg-white/10 hover:scale-105 transition-all duration-500 ease-out relative overflow-hidden group"
                    ...
                    {/*desktop navbar*/}
                    <div className="hidden md:flex items-center space-x-1 bg-white/[0.02] px-2 py-1 rounded-full border border-white/[0.05] shadow-[inset_0_0_20px_rgba(255,255,255,0.02)] backdrop-blur-3xl">
